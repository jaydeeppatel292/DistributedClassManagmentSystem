 ...
 * generated in the com.concordia.dsd.client.webservice.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _EditRecord_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "editRecord");
    private final static QName _GetRecordCountsResponse_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "getRecordCountsResponse");
    private final static QName _CreateSRecord_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "createSRecord");
    private final static QName _CreateSRecordResponse_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "createSRecordResponse");
    private final static QName _GetRecordCounts_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "getRecordCounts");
    private final static QName _TransferRecordResponse_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "transferRecordResponse");
    private final static QName _CreateTRecord_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "createTRecord");
    private final static QName _CreateTRecordResponse_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "createTRecordResponse");
    private final static QName _EditRecordResponse_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "editRecordResponse");
    private final static QName _TransferRecord_QNAME = new QName("http://interfaces.server.dsd.concordia.com/", "transferRecord");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.concordia.dsd.client.webservice.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "editRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "getRecordCountsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "createSRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "createSRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "getRecordCounts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "transferRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "createTRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "createTRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "editRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server.dsd.concordia.com/", name = "transferRecord")
