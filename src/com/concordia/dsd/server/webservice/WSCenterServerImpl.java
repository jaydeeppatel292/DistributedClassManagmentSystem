...
import com.concordia.dsd.server.interfaces.WSCenterServer;

import javax.jws.WebService;
import java.io.IOException;


@WebService(endpointInterface = "com.concordia.dsd.server.interfaces.WSCenterServer")
public class WSCenterServerImpl implements WSCenterServer {

    private CenterServerImpl<WSCenterServerImpl> centerServerCenterImpl;

    public WSCenterServerImpl() {
    }
     ...
     * @return
     */
    public CenterServerImpl<WSCenterServerImpl> getCenterServerCenterImpl() {
