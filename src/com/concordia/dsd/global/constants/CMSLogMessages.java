...
public class CMSLogMessages {
	...
	public static final String CREATED_STUDENT_RECORD_MSG = "Created student record: Record ID = %s by manager %s %s";
    public static final String CREATED_TEACHER_RECORD_MSG = "Created teacher record: Record ID = %s by manager %s %s";
    public static final String UPDATE_RECORD_MSG = "Updated field %s of record with the value %s : Record ID = %s by manager %s %s";
	public static final String RECORD_NOT_FOUND = "Failed to update record: Record {0} Not Found";
