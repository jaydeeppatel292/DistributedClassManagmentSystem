 ...
 implements CenterServerApp.CenterOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("crashProcess", new java.lang.Integer (5));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 5:  // CenterServerApp/Center/crashProcess
       {
         String port = in.read_string ();
         String location = in.read_string ();
         String $result = null;
         $result = this.crashProcess (port, location);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 6:  // CenterServerApp/Center/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
